...
export function StickyNavbar() {
  ...
  return (
    <div className="navbar bg-gray-800 text-white shadow-sm rounded-2xl fixed top-0 left-0 w-full   m-8 z-50">
          ...
          <div className="dropdown dropdown-end">
            <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
              <div className="indicator">
                ...
                <span className="badge badge-sm indicator-item">{eventsPurchased}</span>
              </div>
            </div>
            <div
              tabIndex={0}
            ...
            >
              <div className="card-body">
                <span className="text-lg font-bold">{eventsPurchased} Items</span>
